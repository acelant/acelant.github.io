(function(ThemeBuilder) {
    ...
    var PreviewViewModel = function(cssTemplateLoader, previewRepository, parentIframeNotifier) {
        ...
        this.init = function(metadata, group) {
            ...
            this.isMobileTheme(theme == "ios7");

            this.themeColoring(($.inArray(colorScheme, ["white", "default", "carmine", "greenmist", "softblue", "carmine-compact", "greenmist-compact", "softblue-compact"]) > -1 || colorScheme.indexOf("light") > -1) ? "coloring-light" : "coloring-dark");
        ...
        this.analyzeBootstrapTheme = function(metadata, bootstrapMetadata, customLessContent, version) {
            var theme = this.theme();
            var colorScheme = this.colorScheme();

            return _cssTemplateLoader.analyzeBootstrapTheme(theme, colorScheme, metadata, bootstrapMetadata, customLessContent, version).done(function(compiledMetadata, modifyVars) {
